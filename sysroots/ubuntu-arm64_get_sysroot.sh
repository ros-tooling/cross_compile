...
docker build -t ubuntu-arm64_sysroot -f $THIS_DIR/Dockerfile_ubuntu-arm64 $THIS_DIR

# eventually remove old docker containers
docker kill ros2-ubuntu-arm64-sysroot
docker rm ros2-ubuntu-arm64-sysroot

# create new docker container
docker create --name ros2-ubuntu-arm64-sysroot ubuntu-arm64_sysroot

# extract sysroot from docker container as tar file
docker container export -o $THIS_DIR/$TARGET_ARCHITECTURE.tar ros2-ubuntu-arm64-sysroot
